package com.xinran.qxcustomcamera.systomcamera;
...
import com.xinran.qxcustomcamera.systomcamera.app.TakePhotoFragmentActivity;
 ...
 */
public class SystemCameraMainActivity extends TakePhotoFragmentActivity {
    private ImageView imgShow;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.system_camera_main);
